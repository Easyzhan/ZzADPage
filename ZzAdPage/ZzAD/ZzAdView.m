...
@property (nonatomic,assign) NSInteger secondsCountDown;//倒计时总长
@end
...
#pragma mark 默认广告也展示3秒
    ...
    //获得启动图
#pragma -mark 这里是从非storyboard获得启动图，如果打开将不从storyboard获得启动图
...
#pragma mark 广告页是全屏还是底部有logo的非全屏
    ...
    UIBezierPath *maskPath = [UIBezierPath bezierPathWithRoundedRect:self.skipBtn.bounds byRoundingCorners:UIRectCornerBottomRight | UIRectCornerTopRight |UIRectCornerTopLeft|UIRectCornerBottomLeft cornerRadii:CGSizeMake(15, 15)];
...
- (UIImage *)imageCompressForWidth:(UIImage *)sourceImage targetWidth:(CGFloat)defineWidth {
    ...
    if(newImage == nil){
#pragma -mark发布程序时候，这里的NSLog要注释掉，或者用你的DebugLog代替即可
